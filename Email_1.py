...
def start_email_1():
    def send_message():
        try:
            ...
            channel.basic_publish(exchange='', routing_key='email_queue_2', body=message)
    ...
    def update_queue(channel):
        try:
            method_frame, properties, body = channel.basic_get(queue='email_queue_1')
    ...
    try:
        ...
        channel.queue_declare(queue='email_queue_2', durable=True)
